...
- Ses kaydı başlamadan önce TÜM soruları/seçenekleri **önceden okuyun**
- Bir cevabı kaçırırsanız hemen geçin — bir sonrakini de kaybetmeyin
- Ses kayıtları genellikle **eş anlamlı kelimeler** kullanır (örn. *Urlaub* → *Ferien*, *Arzt* → *Doktor*, *billig* → *günstig*)
- Bölüm 1 sadece BİR KEZ çalar. Çok dikkatli dinleyin.
...
- **Önce soruyu okuyun**, ardından kilit kelimeler için metne göz atın
- Eşleştirme alıştırmalarında bariz yanlış cevapları hemen eleyin
- Bilinmeyen kelimeler mi var? Bağlamdan anlam çıkarmaya çalışın, panik yapmayın
...
- Bu bölüm tamamen dil bilgisi kalıplarını tanımaya yöneliktir — tek tek cevapları değil kalıpları öğrenin
- Sprachbausteine için okuma süresinden zaman ayırın; çoğu kişinin zamanı burada biter

#### Schreiben (Yazma) — ~20 dk

**Yarı resmi bir e-posta/mektup** (~100-120 kelime) yazacaksınız. DEĞİNMENİZ GEREKEN **4 madde** içeren bir durum verilir.

**Stratejiler:**

- TÜM 4 maddeye değinin — birini bile atlamak ciddi puan kaybına neden olur
- Selamlaşma, bağlaçlar ve kapanış için ezberlenmiş şablonlar kullanın
- Hatalı uzun, karmaşık cümleler yerine kısa, net cümleler tercih edin
- 100-120 kelime hedefleyin. 80 kelimenin altı puan kesintisine neden olur

### 2. Sözlü Sınav (~15 dk + 20 dk hazırlık)
...
- **Karşılıklı diyalog!** Her zaman partnerinize tepki verin, takip soruları sorun
- Gülümseyin, arkadaşça davranın — gözetmenler iletişim kurma istekliliğini değerlendirir
