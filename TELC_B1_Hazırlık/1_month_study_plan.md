...
| Gün | Konu | Görevler |
| --- | --- | --- |
| 1. Gün | Teşhis | Tanılama Deneme Sınavını yapın. Zayıf noktalarınızı belirleyin. |
| 2. Gün | Bağlaçlar | ADUSO (0. Pozisyon) ve Devrik Yapı (1. Pozisyon: deshalb, trotzdem) çalışın. |
| 3. Gün | Yan Cümleler | Yan cümle bağlaçları (weil, dass, wenn, ob). **Fiil en sona gider.** |
