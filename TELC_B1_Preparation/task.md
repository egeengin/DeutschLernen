...
- [x] Create a detailed day-by-day or week-by-week 1-month schedule.
- [x] Focus on high-yield topics to optimize learning speed.

## 3. Preparation Material by Subject

- [x] Prepare review material for Subject 1 (e.g., Reading/Lesen).
...
- [x] Create an initial diagnostic mock exam to assess the user's current level.
- [x] Create final mock exams to practice time management and exam readiness.
