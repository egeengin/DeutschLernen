...
1. **Keyword-Synonym Matching:** The exam uses different words than the text. Look for synonyms! (e.g., *gratis* instead of *kostenlos*).
2. **Global to Detail:** Read the title and the first/last sentences first to get the main idea.
3. **Time Boxing:** Don't spend more than 10-12 minutes on any single part.
...
### Strategies for Success
1. **Read Before Listening:** You have a small window to read the questions before the audio starts. Use it!
2. **Contextualize:** Who is speaking? Where are they? (Radio, Station, Private call?)
3. **Don't Dwell:** If you miss an answer, let it go and focus on the next one immediately.
